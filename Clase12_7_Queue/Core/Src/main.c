...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define SYS_TICK_MS (float)0.1
#define SYS_TICK_RTOS_MS 1
#define TOGGLE_0_5Hz 1000/SYS_TICK_RTOS_MS
#define TOGGLE_2Hz 250/SYS_TICK_RTOS_MS
